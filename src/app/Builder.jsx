...
function Builder() {
  ...
  const SiteHero = (props) => {
    return (
      <section id="hero" style={{ backgroundColor: '#' + props.siteColor + '3F' }} className='px-8 py-16  '>
        <div className="mx-auto max-w-7xl  flex flex-col gap-1">
          <h1 className='hidden'>{props.name}'s Portfolio</h1>
          ...
          <div className="space-x-4 mt-4">
            <a href="#" style={{ backgroundColor: '#' + props.siteColor }} className="inline-block rounded-md border border-transparent py-2 px-4 text-base font-medium text-white hover:bg-gray-50">
              {props.siteCTA}
              </a>
          </div>
        </div>
  ...
  const SitePreview = () => {
    return (
      ...
      {/* <SiteHero siteColor={siteColor} siteCTA={siteCTA} name={name} header={siteHeader} subheader={siteSubheader} /> */}
      ...
      <section id="cta" style={{ backgroundColor: '#' + siteColor + '6F' }} className='px-8 py-16 '>
        <div className="mx-auto max-w-7xl flex flex-col gap-1">
          ...
          <div className="space-x-4 mt-4 max-w-5xl">
            <a href="#" className="inline-block rounded-md border border-transparent py-2 px-4 text-base font-medium bg-white text-black hover:bg-gray-50">{siteCTA}</a>
          </div>
        </div>
      </section>
